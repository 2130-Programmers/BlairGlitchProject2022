...
public class DriveTrain extends SubsystemBase {
  ...
  /**Runs our Swerve drive
   * 
   * @param leftX (double) axis 0
   * @param leftY (double) axis 1 
   * @param rightX (double) axis 4 
   */
...
//creates dead zones on the joystick
  ...
  /**For autonoumous, turns us in a selected direction
   * 
   * @param path (int) - 1 is left, 2 is stop, 3 is right
   */
  public void autonTurn(int path){
    ...
    /**moves toward a ball targeted by our camera*/
    public void autonRun(){
      moveSwerveAxis(0, .35, PhotonSub.yaw*-.009);
    }

    /**for autonomous, stops our swerve drive and sets a variable allowing us to shoot. */
    public void halt(){
      moveSwerveAxis(0, 0, 0);
      notMoving = true;
    }
}
